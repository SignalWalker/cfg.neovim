return function()
	...
	local set_keymaps = function(client, bufnr)
		...
		vim.keymap.set("n", "<Leader>fla", function()
			tsb.lsp_code_actions(tst.get_cursor())
		end, kopts("actions"))
		vim.keymap.set("n", "<Leader>flr", function()
			tsb.lsp_references(tst.get_cursor())
		end, kopts("references"))
		vim.keymap.set("n", "<Leader>fld", function()
			tsb.lsp_definitions(tst.get_cursor())
		end, kopts("definitions"))
		vim.keymap.set("n", "<Leader>flt", function()
			tsb.lsp_type_definitions(tst.get_cursor())
		end, kopts("type definitions"))
		vim.keymap.set("n", "<Leader>fli", function()
			tsb.lsp_implementations(tst.get_cursor())
		end, kopts("implementations"))
		...
		vim.keymap.set(
			...
			kopts("trouble :: toggle (lsp references)")
		)
		vim.keymap.set(
			"n",
			"<Leader>xld",
			"<cmd>TroubleToggle lsp_references<cr>",
			kopts("trouble :: toggle (lsp definitions)")
		)
		vim.keymap.set(
			"n",
			"<Leader>xlt",
			"<cmd>TroubleToggle lsp_type_definitions<cr>",
			kopts("trouble :: toggle (lsp type definitions)")
		)
		...
		vim.keymap.set("n", "<Leader>du", function()
			dapui.toggle({})
		end, kopts("toggle dapui"))
		vim.keymap.set("n", "<Leader>db", function()
			dap.toggle_breakpoint()
		end, kopts("toggle breakpoint"))
		vim.keymap.set("n", "<F5>", function()
			dap.continue()
		end, kopts("dap :: continue"))
		vim.keymap.set("n", "<S-<F5>>", function()
			dap.restart()
		end, kopts("dap :: restart"))
		vim.keymap.set("n", "<C-S-<F5>>", function()
			dap.run_last()
		end, kopts("dap :: run last"))
		vim.keymap.set("n", "<F10>", function()
			dap.step_over()
		end, kopts("dap :: step over"))
		vim.keymap.set("n", "<F11>", function()
			dap.step_into()
		end, kopts("dap :: step into"))
		vim.keymap.set("n", "<S-<F11>>", function()
			dap.step_out()
		end, kopts("dap :: step out"))
		vim.keymap.set("n", "<Leader>dsi", function()
			dap.step_into()
		end, kopts("dap :: step into"))
		vim.keymap.set("n", "<Leader>fdc", function()
			tsdap.commands({})
		end, kopts("dap :: commands"))
		vim.keymap.set("n", "<Leader>fdo", function()
			tsdap.configurations({})
		end, kopts("dap :: configurations"))
		vim.keymap.set("n", "<Leader>fdb", function()
			tsdap.list_breakpoints({})
		end, kopts("dap :: breakpoints"))
		vim.keymap.set("n", "<Leader>fdv", function()
			tsdap.variables({})
		end, kopts("dap :: variables"))
		vim.keymap.set("n", "<Leader>fdf", function()
			tsdap.frames({})
		end, kopts("dap :: frames"))
	end
